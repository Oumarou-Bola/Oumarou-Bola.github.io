...
<img src="/images/omb-profile-600-embedded.svg" alt="Oumarou Moussa Bola" 
     style="width: 250px; float: right ; border-radius: 10px; margin: 0 0 20px 20px;">
...
- **Network Optimisation in Transportation**  
  Cost optimisation in transportation networks using **communicability metrics**, matrix methods, and tools from network theory.

- **AI for Flight Control Systems**  
  Application of artificial intelligence and control theory to aircraft flight control, autopilot design, and flight mechanics using Matlab–Simulink.

- **Aerodynamics, CFD, and Structural Analysis**  
  Studies on NACA airfoils, turbulence modelling with Ansys Fluent, structural behaviour of aircraft under complex loads, and finite element modelling of thermal problems.
...
- **Football, running**, and staying active  
